...
<section id="bo_w">
    ...
    <!-- 게시물 작성/수정 시작 { -->
    <form name="fwrite" id="fwrite" action="<?php echo $action_url ?>" onsubmit="return fwrite_submit(this) changeSlider();" onclick="" method="post" enctype="multipart/form-data" autocomplete="off" style="width:<?php echo $width; ?>">
...
<form action="../index.php" method="post">
    ...
    <input type="submit" value="적용" id="apply-button"/>
</form>
